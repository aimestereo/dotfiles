...
Trigger: you and the commander are deciding to break a feature into **2+ Jira issues** (not just 2+ PRs on one issue). The moment that decision is on the table, this rule fires.
