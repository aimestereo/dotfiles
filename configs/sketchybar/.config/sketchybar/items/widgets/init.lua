...
local separator = require("items.widgets.separator_right")
local network = require("items.widgets.network")
local disk = require("items.widgets.disk")
local memory = require("items.widgets.memory")
...
stats.close = function()
  Sbar.animate("tanh", 30, function()
    cpu:set({ background = { padding_right = -50 } })
    memory:set({ background = { padding_right = -40 } })
    disk:set({ background = { padding_right = -10 } })
...
stats.open = function()
  ...
  Sbar.animate("tanh", 30, function()
    ...
    network.bracket:set({ drawing = true })
    network.icon:set({ drawing = true })
    ...
    network.bracket:set({ background = { padding_right = 0 } })
    network.icon:set({ background = { padding_right = 0 } })
    network.up:set({ background = { padding_right = 0 } })
