# Differ from default by using a custom default color
...
show_cpu() {
	...
	tmux_batch_options_commands+=("set-option -gq @cpu_low_bg_color $thm_blue ;")      # background color when cpu is low
