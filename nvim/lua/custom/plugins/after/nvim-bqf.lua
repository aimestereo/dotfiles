...
vim.keymap.set('n', '<leader>j', '<cmd>cnext<CR>zz', { desc = 'Moves the cursor to the next item in the quickfix list' })
vim.keymap.set('n', '<leader>k', '<cmd>cprev<CR>zz', { desc = 'Moves the cursor to the previous item in the quickfix list' })
